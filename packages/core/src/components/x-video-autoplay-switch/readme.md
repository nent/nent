...
The `<x-video-autoplay-switch>` component displays a checkbox to control the autoplay setting used for video playback - as well as automatic navigation to the next page, when a video ends.
